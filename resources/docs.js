...
Ext.BrowserPanel = Ext.extend(Ext.Panel, {
    anchor: '100%',
    frame: false,
    collapsible: false,
    draggable: false,
    ...
    getDocument : function() {
        return this.body.dom.contentDocument;
    },

    getLongDesc : function(){
        return this.body.dom.longdesc;
    },
...
Ext.reg('browserpanel', Ext.BrowserPanel);
...
DocPanel = Ext.extend(Ext.BrowserPanel, {
    closable: true,
    autoScroll:true,
    ...
    initComponent : function(){
        ...
        Ext.apply(this,{
            tbar: ['<b style="font-size:115%">'+me.filename+'</b>','->',{
                text: 'Constants',
                handler: function(btn,e) {
                    var url = me.getSrc();
                    url = url.split('#');
                    url = url[0]+'#anchor-class-constants';
                    me.setSrc(url);
                },
                iconCls: 'icon-config'
            },'-',{
                ...
                handler: function(btn,e) {
                    var url = me.getSrc();
                    url = url.split('#');
                    url = url[0]+'#anchor-class-properties';
                    me.setSrc(url);
                },
                iconCls: 'icon-prop'
            }, '-',{
                ...
                handler: function(btn,e) {
                    var url = me.getSrc();
                    url = url.split('#');
                    url = url[0]+'#anchor-class-methods';
                    me.setSrc(url);
                },
                iconCls: 'icon-method'
            }, /*'-',{
                ...
                toggleHandler : function(b, pressed){
                     ...
                     var bodyDoc = me.getDocument(),
                         showSwitch = bodyDoc.getElementById('show-inherited');
                         if (showSwitch && showSwitch.click) showSwitch.click();
                }
            }, '-',{
                //tooltip:'Hide Inherited Members',
                //iconCls: 'icon-hide-inherited',
                ...
                toggleHandler : function(b, pressed){
                     //this.body[pressed ? 'addClass' : 'removeClass']('hide-inherited');
                     var bodyDoc = me.getDocument(),
                         showSwitch = bodyDoc.getElementById('show-public');
                         if (showSwitch && showSwitch.click) showSwitch.click();
               }
            }, '-',{
                //tooltip:'Hide Inherited Members',
                ...
                toggleHandler : function(b, pressed){
                     //this.body[pressed ? 'addClass' : 'removeClass']('hide-inherited');
                     var bodyDoc = me.getDocument(),
                         showSwitch = bodyDoc.getElementById('show-protected');
                         if (showSwitch && showSwitch.click) showSwitch.click();
                }
            }, '-',{
                //tooltip:'Hide Inherited Members',
                ...
                toggleHandler : function(b, pressed){
                     //this.body[pressed ? 'addClass' : 'removeClass']('hide-inherited');
                     var bodyDoc = me.getDocument(),
                         showSwitch = bodyDoc.getElementById('show-private');
                         if (showSwitch && showSwitch.click) showSwitch.click();
                }
            }, '-', {
...
Ext.onReady(function(){
    ...
    if(page){
        ...
        var cls = ps['class'];
        mainPanel.loadClass('files/' + cls + '.html', cls, ps.member);
    }
